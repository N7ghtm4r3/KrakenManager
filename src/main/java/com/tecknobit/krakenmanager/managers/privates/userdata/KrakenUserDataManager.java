...
public class KrakenUserDataManager extends KrakenPrivateManager {
     ...
     * @param jsonOrder: obtained by response request
     ...
     * @param jsonTrades: obtained by response request
     ...
     * @param jsonPositions: obtained by response request
     ...
     * @param jsonLedgers: obtained by response request
