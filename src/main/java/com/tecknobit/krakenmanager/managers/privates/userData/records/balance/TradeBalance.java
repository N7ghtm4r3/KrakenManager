...
public class TradeBalance extends KrakenManager.KrakenResponse {
    ...
    public TradeBalance(JSONObject jsonResponse, double equivalentBalance, double tradeBalance, double marginAmount,
                        double unrealizeIncome, double costBasis, double floatingValuation, double equity,
                        double freeMargin, String marginLevel, double unexecutedValue) {
        super(jsonResponse);
    ...
    public TradeBalance(double equivalentBalance, double tradeBalance, double marginAmount, double unrealizeIncome,
        ...
        this(null, equivalentBalance, tradeBalance, marginAmount, unrealizeIncome, costBasis, floatingValuation,
                equity, freeMargin, marginLevel, unexecutedValue);
    }
    ...
    public TradeBalance(JSONObject jsonResponse) {
        ...
        unexecutedValue = tradeBalance.getDouble("uv");
    }
