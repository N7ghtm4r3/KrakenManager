...
```gradle
dependencies {
	implementation 'com.github.N7ghtm4r3:KrakenManager:1.0.1'
}
```
...
[![](https://img.shields.io/badge/Java-ED8B00?style=for-the-badge&logo=java&logoColor=white)](https://github.com/N7ghtm4r3/KrakenManager/blob/main/README.md)
